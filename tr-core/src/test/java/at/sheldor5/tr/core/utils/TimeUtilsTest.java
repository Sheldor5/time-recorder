...
public class TimeUtilsTest {
  ...
  public void test_millis_to_summary() {
    ...
    actual = TimeUtils.getHumanReadableSummary(1L * TimeUtils.HOUR_IN_MILLIS);
    ...
    actual = TimeUtils.getHumanReadableSummary(24L * TimeUtils.HOUR_IN_MILLIS);
    Assert.assertEquals("Formatting milliseconds to human readable summary format failed", "24:00:00", actual);

    actual = TimeUtils.getHumanReadableSummary(100L * TimeUtils.HOUR_IN_MILLIS);
